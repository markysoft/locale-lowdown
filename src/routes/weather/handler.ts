...
export async function handleGetWeather(req: Request, res: ResponseBuilder): Promise<void> {
...
export async function handleGetWeekWeather(req: Request, res: ResponseBuilder): Promise<void> {
